...
export default function Sidebar(props:any) {
  ...
  const navihandler = (indexpath:any) => {
    navigate(`/${indexpath}`);
  };
  const menuItems_1 = [
    { index: '', text: 'Home', IconComponent: HomeOutlinedIcon, ActiveIconComponent: HomeIcon },
  ...
  const menuItems_2login = [
    ...
    { index: 'Yourvideos', text: 'Your Videos', IconComponent: YourVideoOutlinedIcon, ActiveIconComponent: YourVideoIcon },
    { index: 'Watchlater', text: 'Watch Later', IconComponent: WatchLaterOutlinedIcon, ActiveIconComponent: WatchLaterIcon },
    { index: 'Likedvideos', text: 'Liked Videos', IconComponent: LikedVideosOutlinedIcon, ActiveIconComponent: LikedVideosIcon }
  ];
  ...
  return (
    <>
      {props.isHamburger ? (
        <>
          <Box
            sx={{ width: 200, bgcolor: "background.paper", height: "100vh" }}
          >
            <List className="list-1">
              {menuItems_1.map((item, index) => (
                <ListItemLink
                  ...
                  text={item.text}
                  onclick={() => navihandler(item.index)}
                />
              ))}
            </List>
            ...
            <List
              className="list-3"
              sx={{ borderTop: "1px solid #ccc", paddingTop: 0 }}
            >
              {isLogin ? (
